...
os.environ["LLM_PROVIDER"]="openai" #research_config["llm_provider"]
os.environ["FAST_LLM_MODEL"]="gpt-4o-mini" #research_config["fast_llm_model"]
os.environ["SMART_LLM_MODEL"]="gpt-4o" #research_config["smart_llm_model"]
