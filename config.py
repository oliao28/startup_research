...
research_config = {
	...
	"prompt": """Write a short report containing the following sections, using simple bullet points whenever possible. 
            Within each section, ask the investors to deep dive into critical questions that we do not yet know the answers of.
            Only the listed sections are needed in the report. Once done writing, remove any introduction before the website URL, and remove any conclusion section. 
